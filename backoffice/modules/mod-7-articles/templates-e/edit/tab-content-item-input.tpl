<div role="tabpanel" class="tab-pane fade {c2r-class}" id="content-{c2r-nr}">
	...
	<div class="spacer all-15"></div>
	<div class="form-group">
		<label for="inputContent-{c2r-nr}">{c2r-label-content}</label>
		<textarea id="inputContent-{c2r-nr}" class="form-control editor" rows="10" name="content[]"  placeholder="{c2r-label-content}-{c2r-nr}" required="">{c2r-content-value}</textarea>
	</div>
