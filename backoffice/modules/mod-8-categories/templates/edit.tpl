		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="form-group">
					...
					<input list="category-type" name="category-type" class="bo3-form-control form-control" type="text" placeholder="{c2r-select-option-type}" id="inputType" value="{c2r-type-value}" required>
				...
				<div class="form-group">
					...
					<input name="sort" id="inputSort" type="number" class="bo3-form-control form-control" placeholder="{c2r-sort-placeholder}" value="{c2r-sort-value}" required>
				</div>
				<!-- END Category Sort -->
				<div class="spacer all-15"></div>
				<!-- Category Code -->
				<div class="form-group">
					...
					<textarea name="code" id="inputCode" class="bo3-form-control form-control" rows="1"  placeholder="{c2r-code-placeholder}" style="resize: vertical;">{c2r-code-value}</textarea>
				</div>
				<!-- END Category Code -->
				<div class="spacer all-15"></div>
				<!-- Category Published -->
